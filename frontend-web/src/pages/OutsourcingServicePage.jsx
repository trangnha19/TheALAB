/**
 * OutsourcingServicePage.jsx — Trang Chi Tiết Dịch Vụ
 * "Gia công Giải pháp Công nghệ"
 * Route: /services/outsourcing
 *
 * Bám sát 100% thiết kế dvchitiet2page.png:
...
/* ── Solid Check Icon (vòng tròn xanh, tích trắng) ── */
function SolidCheck() {
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-6 pb-0">
        <nav className="flex items-center gap-2 text-[13px] text-slate-400">
          ...
          <span>/</span>
          <span className="text-[#3ea54a] font-semibold">Gia công giải pháp công nghệ</span>
        </nav>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h1 className="text-3xl md:text-[2.2rem] font-extrabold text-[#0a2540] leading-tight mb-4">
              Gia công Giải pháp<br />Công nghệ
            </h1>
            <p className="text-[15px] text-slate-500 leading-relaxed mb-6 max-w-lg">
              ...
              và linh hoạt, giúp doanh nghiệp tối ưu chi phí và rút ngắn thời gian phát triển
              sản phẩm.
            </p>
          ...
          <div className="flex items-center justify-center">
            <img
              src="/dichvu/dvchitiet2/1.png"
              alt="Gia công Giải pháp Công nghệ"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7
              ...
              <h3 className="text-[15px] font-bold text-[#0a2540] mb-2">Thiếu nhân lực IT chất lượng</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed">
                Khó tuyển dụng &amp; duy trì đội ngũ phát triển phần mềm phù hợp.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7
              ...
              <h3 className="text-[15px] font-bold text-[#0a2540] mb-2">Chi phí vận hành cao</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed">
                Chi phí nhân sự, tuyển dụng và đào tạo tốn kém.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7
              ...
              <h3 className="text-[15px] font-bold text-[#0a2540] mb-2">Tiến độ dự án chậm</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed">
                Thiếu nhân lực khiến dự án kéo dài, bỏ lỡ cơ hội kinh doanh.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7
              ...
              <h3 className="text-[15px] font-bold text-[#0a2540] mb-2">Khó mở rộng linh hoạt</h3>
              <p className="text-[13px] text-slate-500 leading-relaxed">
                Không thể tăng / giảm nhân sự nhanh theo nhu cầu.
              </p>
            </div>
      ...
      <section className="py-16 border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Cột trái: ảnh lập trình viên + icon tech */}
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl border border-slate-100">
                <img
                  src="/dichvu/dvchitiet2/2.png"
                  alt="Đội ngũ gia công công nghệ"
                  className="w-full h-auto object-cover"
                />
              </div>
              {/* Tech badges nổi */}
              <div className="absolute -top-3 -left-3 bg-white rounded-xl px-3 py-2 shadow-lg
                              border border-slate-100 flex items-center gap-2">
                <span className="text-[11px] font-extrabold text-blue-600">.NET</span>
              </div>
              <div className="absolute top-10 -right-3 bg-white rounded-xl px-3 py-2 shadow-lg
                              border border-slate-100">
                <span className="text-[11px] font-extrabold text-yellow-500">JS</span>
              </div>
              <div className="absolute -bottom-3 -left-3 bg-white rounded-xl px-3 py-2 shadow-lg
                              border border-slate-100">
                <span className="text-[11px] font-extrabold text-blue-400">Python</span>
              </div>
              <div className="absolute bottom-10 -right-3 bg-white rounded-xl px-3 py-2 shadow-lg
                              border border-slate-100">
                <span className="text-[11px] font-extrabold text-cyan-500">React</span>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    desc: 'Phát triển phần mềm, tính năng theo đặc thù của DN.',
                  },
                  {
                    title: 'Bổ sung nhân sự IT',
                    desc: 'Cung cấp lập trình viên, tester, devops... nhanh chóng, chất lượng.',
                  },
                  {
                    title: 'Đảm bảo chất lượng',
                    desc: 'Quy trình kiểm soát chất lượng chặt chẽ, cam kết sản phẩm ổn định.',
                  },
                  {
                    title: 'Bảo mật thông tin',
                    desc: 'Cam kết bảo mật tuyệt đối dữ liệu và mã nguồn của khách hàng.',
                  },
                  {
                    title: 'Hỗ trợ dài hạn',
                    desc: 'Đồng hành, bảo trì và nâng cấp sau khi bàn giao sản phẩm.',
                  },
                ].map((feat) => (
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['React', 'Angular', 'Vue', 'TypeScript'].map((tech) => (
                    <span key={tech}
                      className="inline-flex items-center px-3 py-1.5 rounded-full
                                 bg-slate-100 text-slate-700 text-[12px] font-semibold
                                 border border-slate-200 hover:border-[#3ea54a] hover:text-[#3ea54a]
